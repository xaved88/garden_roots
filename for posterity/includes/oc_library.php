...
function fill_OC_section($div_id,$id){
	switch($div_id){
		// STAFF ONES
		case 'oc_staff_details':
			echo "staff details from the fill function.";
			break;
		case 'oc_staff_av':
			echo "staff av from the fill function.";
			break;
		case 'oc_staff_away':
			echo "staff away from the fill function.";
			break;
		case 'oc_staff_here':
			echo "staff here from the fill function.";
			break;
		case 'oc_staff_lang':
			echo "staff lang from the fill function.";
			break;
		case 'oc_staff_pos':
			echo "staff pos from the fill function.";
			break;
	}
}
?>